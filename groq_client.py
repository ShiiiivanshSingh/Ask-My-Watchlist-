...
class GroqClient:
    def __init__(self, model="openai/gpt-oss-20b", max_tokens=1000, api_key=None, user_name="Shivansh"):
        ...
        self.system_prompt = (
            ...
            f"Talk PRECISELY around  150 words / 1000 characters per response but concisely not adding unnecessary details, like a close friend who's read every entry, not like a database "
            ...
            f"friend, no em dashes in response, always talk PRECISELY around  150 words / 1000 characters per response and to the point AND concisely not adding unnecessary details, not like flagging a missing database record."
            f"\n\n"
